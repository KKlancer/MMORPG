--服务器返回角色信息
RoleOperation_SelectRoleInfoReturnProto = { ProtoCode = 10010, IsSucess = false, MessageId = 0, RoldId = 0, RoleNickName = "", JobId = 0, Level = 0, Money = 0, Gold = 0, Exp = 0, MaxHP = 0, MaxMP = 0, CurrHP = 0, CurrMP = 0, Attack = 0, Defense = 0, Hit = 0, Dodge = 0, Cri = 0, Res = 0, Fighting = 0, LastInWorldMapId = 0, LastInWorldMapPos = "" }
...
function RoleOperation_SelectRoleInfoReturnProto.SendProto(proto)
    ...
    ms:WriteBool(proto.IsSucess);
    if(proto.IsSucess) then
        ms:WriteInt(RoldId);
