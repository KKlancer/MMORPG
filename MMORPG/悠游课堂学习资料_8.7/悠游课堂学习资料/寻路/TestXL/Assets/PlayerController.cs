...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, Mathf.Infinity, 1 << LayerMask.NameToLayer("Ground")))//判断要移动到的目标点
            {
    ...
    /// 开始通过A*寻路，走到目标点
    /// </summary>
    /// <param name="AStarTargetPos">目标点坐标</param>
