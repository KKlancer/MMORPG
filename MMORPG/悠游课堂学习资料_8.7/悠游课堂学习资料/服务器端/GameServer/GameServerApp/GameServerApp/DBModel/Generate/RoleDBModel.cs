...
public partial class RoleDBModel : MFAbstractSQLDBModel<RoleEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "AccountId", "JobId", "NickName", "Sex", "Level", "Money", "Gold", "Exp", "MaxHP", "MaxMP", "CurrHP", "CurrMP", "Attack", "Defense", "Hit", "Dodge", "Cri", "Res", "Fighting", "LastPassGameLevelId", "LastInWorldMapId", "LastInWorldMapPos", "CreateTime", "UpdateTime" };
            }
            return _ColumnList;
        }
    }
